...
Access via Tools → Price List section.

In this section, all products are displayed in table format.
...
* **Unit of Measure** – product unit (kg, piece, etc.)
* **Category** – product category
* **SKU** – product code
* **Quantity** – available balance quantity
* **Barcode** – product barcode
* **Last Price** – last set price
* **Average Price** – average cost or price
* **Retail / Wholesale** – sales price types
