...
Navigate to Data → Legal Entities and add a new organization through the **"Create"** button.

<figure><img src="../../.gitbook/assets/image (8).png" alt=""><figcaption></figcaption></figure>

In this section, all legal entities are displayed in table view.

#### Table columns:

* **Name** – organization name
* **Code** – internal identification code
* **Short name** – abbreviated name
* **Phone number** – contact phone
* **Status** – active or inactive status

#### When creating a new legal entity, the following main information is entered:

* **Name** – organization name
* **Code** – unique code in the system
* **Responsible person** – user assigned to this organization
* **Phone number** – contact number
* **Address** – location address
* **TIN** – tax identification number
* **Parent company** – related organization (if exists)
* **Email / Telegram / Website** – additional contact information
