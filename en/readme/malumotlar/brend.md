...
Navigate to Data → Brand section and add a new brand using the **"Create"** button.

<figure><img src="../../.gitbook/assets/image (14).png" alt=""><figcaption></figcaption></figure>

In this section, all brands are displayed in a table view.

#### Table columns:

* **Name** – brand name

#### When creating a new brand, the following basic information is entered:

* **Name** – brand name
* **Manufacturer** – the manufacturer associated with this brand
* **Image** – brand logo or image
